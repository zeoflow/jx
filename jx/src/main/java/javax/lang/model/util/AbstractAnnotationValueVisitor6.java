        ...
        implements AnnotationValueVisitor<R, P>
{
     ...
     * value's {@link javax.lang.model.element.AnnotationValue#accept accept}.  The invocation
     * {@code v.visit(av)} is equivalent to {@code av.accept(v, p)}.
     *
     * @param av {@inheritDoc}
     * @param p  {@inheritDoc}
     */
    public final R visit(javax.lang.model.element.AnnotationValue av, P p)
    {
    ...
    /**
     * Visits an annotation value as if by passing itself to that
     * value's {@link javax.lang.model.element.AnnotationValue#accept accept} method passing
