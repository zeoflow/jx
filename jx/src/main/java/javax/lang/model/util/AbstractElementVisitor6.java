...
public abstract class AbstractElementVisitor6<R, P> implements ElementVisitor<R, P>
{
     ...
     * element's {@link javax.lang.model.element.Element#accept accept} method.  The invocation
     ...
     */
    public final R visit(javax.lang.model.element.Element e, P p)
    {
    ...
    /**
     * Visits any program element as if by passing itself to that
     * element's {@link javax.lang.model.element.Element#accept accept} method and passing
