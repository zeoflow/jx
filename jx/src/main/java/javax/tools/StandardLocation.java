...
public enum StandardLocation implements javax.tools.JavaFileManager.Location
{
    ...
    //where
    private static final ConcurrentMap<String, javax.tools.JavaFileManager.Location> locations
            = new ConcurrentHashMap<String, javax.tools.JavaFileManager.Location>();
    /**
    ...
    public static javax.tools.JavaFileManager.Location locationFor(final String name)
    {
        if (locations.isEmpty())
        {
            ...
            for (javax.tools.JavaFileManager.Location location : values())
