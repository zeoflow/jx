 ...
 * controlled.  For example, for a {@link JavaCompiler
 * JavaCompiler} the list of candidate processors to run can be
 * {@linkplain JavaCompiler.CompilationTask#setProcessors
 * set directly} or controlled by a {@linkplain
 * StandardLocation#ANNOTATION_PROCESSOR_PATH search path}
...
public interface Processor
{
     ...
     * <blockquote>
     * <pre>
     * import static jx.annotation.processing.Completions.*;
     * ...
